...
#      | vasya | qwerty123 | 99999 |
  ...
  Сценарий: Вход в личный кабинет (укороченный)
    ...
    Когда он переводит "5000" рублей с карты с номером "5559 0000 0000 0002" на свою "5559 0000 0000 0001" карту с главной страницы
    Тогда баланс его "5559 0000 0000 0001" карты из списка на главной странице должен стать "15000" рублей
